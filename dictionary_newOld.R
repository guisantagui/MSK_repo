setwd("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_newData/dictionary_NewOld_dataSets")

load("../normMetAnal_ND/metabolitePeaks.RData")
load("../../wrkng_dirs/metabolitePeaks_preCur.RData")

metabolitePeaks$`Compound Name`[!metabolitePeaks$`Compound Name` %in% metabolitePeaks_preCur$`Compound Name`]
