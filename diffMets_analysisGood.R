setwd("/Users/santamag/Desktop/GUILLEM/wrkng_dirs/diffMetAnalGood")
...
#Load data
ccmn_norm_mets <- read.csv("/Users/santamag/Desktop/GUILLEM/wrkng_dirs/NormMet_good/normalized_ccmn_good.csv")
...
if(!require(tibble)) install.packages("tibble")
library(tibble)
load("/Users/santamag/Desktop/GUILLEM/wrkng_dirs/NormMet_Good/compNames.RData")
load("/Users/santamag/Desktop/GUILLEM/wrkng_dirs/NormMet_Good/alldataMet.RData")
load("/Users/santamag/Desktop/GUILLEM/wrkng_dirs/NormMet_Good/missingMet.RData")
load("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_newData/dictionary_NewOld_dataSets/dictionary.RData")

compNames[colnames(alldataMet$featuredata) %in% colnames(missingMet$featuredata) & !alldataMet$metabolitedata$IS == 1]

compNames <- compNames[colnames(alldataMet$featuredata) %in% colnames(missingMet$featuredata) & !alldataMet$metabolitedata$IS == 1]

compKEGGIDs <- dictionary$`KEGG IDs`[dictionary$Consensus %in% compNames]


colnames(ccmn_norm_mets) <- compNames
...
write.csv(diffMets, file = "diffMets_allClusts.csv")
